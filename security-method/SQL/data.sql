...
-- 테스트
INSERT INTO user (id, username, password, name, email )
VALUES (UUID(), 'test', '$2a$12$TrN..KcVjciCiz.5Vj96YOBljeVTTGJ9AUKmtfbGpgc9hmC7BxQ92', '테스트', 'test@mail.com' );

-- 권한
-- 사용자 
-- * 권한 : ROLE_USER
INSERT INTO user_auth (id, user_no, username,  auth )
VALUES (UUID(), 1, 'user', 'ROLE_USER' );
-- 관리자
-- * 권한 : ROLE_USER, ROLE_ADMIN
INSERT INTO user_auth (id, user_no, username,  auth )
VALUES (UUID(), 1, 'admin', 'ROLE_USER' );

INSERT INTO user_auth (id, user_no, username,  auth )
VALUES (UUID(), 1, 'admin', 'ROLE_ADMIN' );
-- 사용자 
-- * 권한 : ROLE_USER
INSERT INTO user_auth (id, user_no, username,  auth )
VALUES (UUID(), 1, 'test', 'ROLE_USER' );
-- ###################################################################################
